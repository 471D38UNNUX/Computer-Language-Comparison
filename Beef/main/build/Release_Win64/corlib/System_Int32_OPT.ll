...
define noundef i1 @"?get__IsNaN__im@IIsNaN@System@bf@@Int32@23@CA_NH@Z"(i32 %this) local_unnamed_addr #0 {
entry:
  ret i1 false
}

; Function Attrs: nounwind uwtable
define void @"?ToString__im@Int32@System@bf@@SAXHPEAVString@23@0PEAVIFormatProvider@23@@Z"(i32 %this, ptr %outString, ptr %format, ptr %formatProvider) local_unnamed_addr #1 {
entry:
  %strChars.i = alloca [16 x i8], align 1
...
if.then:                                          ; preds = %entry, %lor.rhs
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %strChars.i)
  %2 = icmp slt i32 %this, 0
  %3 = tail call i32 @llvm.abs.i32(i32 %this, i1 false)
  %notsub17.i = add i32 %3, -1
  %4 = icmp sgt i32 %notsub17.i, -1
  br i1 %4, label %while.body.i, label %if.then1.i

while.body.i:                                     ; preds = %if.then, %while.body.i
  %char8Idx.019.i = phi i32 [ %11, %while.body.i ], [ 14, %if.then ]
  %.pn18.i = phi i32 [ %10, %while.body.i ], [ %3, %if.then ]
  %5 = sext i32 %char8Idx.019.i to i64
  %6 = getelementptr inbounds [16 x i8], ptr %strChars.i, i64 0, i64 %5
  %7 = urem i32 %.pn18.i, 10
  %8 = trunc i32 %7 to i8
  %9 = or disjoint i8 %8, 48
  store i8 %9, ptr %6, align 1
  %10 = udiv i32 %.pn18.i, 10
  %11 = add i32 %char8Idx.019.i, -1
  %.not.i = icmp ult i32 %.pn18.i, 10
...
if.then1.i:                                       ; preds = %while.end.i, %if.then
  %13 = getelementptr inbounds [16 x i8], ptr %strChars.i, i64 0, i64 14
  store i8 48, ptr %13, align 1
  br label %if.end2.i

if.end2.i:                                        ; preds = %if.then1.i, %while.end.i
  %char8Idx.1.i = phi i32 [ 13, %if.then1.i ], [ %11, %while.end.i ]
  br i1 %2, label %if.then3.i, label %"?ToString__im@Int32@System@bf@@SAXHPEAVString@23@@Z.exit"

if.then3.i:                                       ; preds = %if.end2.i
  %14 = add i32 %char8Idx.1.i, -1
  %15 = sext i32 %char8Idx.1.i to i64
  %16 = getelementptr inbounds [16 x i8], ptr %strChars.i, i64 0, i64 %15
  store i8 45, ptr %16, align 1
  br label %"?ToString__im@Int32@System@bf@@SAXHPEAVString@23@@Z.exit"

"?ToString__im@Int32@System@bf@@SAXHPEAVString@23@@Z.exit": ; preds = %if.end2.i, %if.then3.i
  %char8Idx.2.i = phi i32 [ %14, %if.then3.i ], [ %char8Idx.1.i, %if.end2.i ]
  %17 = sext i32 %char8Idx.2.i to i64
  %18 = add nsw i64 %17, 1
  %19 = getelementptr inbounds [16 x i8], ptr %strChars.i, i64 0, i64 %18
  %20 = sub nsw i64 14, %17
  call void @"?Append@String@System@bf@@QEAAXPEADTint@@@Z"(ptr %outString, ptr nonnull %19, i64 %20)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %strChars.i)
  br label %exit
...
if.else:                                          ; preds = %lor.rhs
  ...
  call void @"?NumberToString@NumberFormatter@System@bf@@SAXUStringView@23@HPEAVIFormatProvider@23@PEAVString@23@@Z"(ptr %22, i64 %24, i32 %this, ptr %formatProvider, ptr %outString)
  br label %exit

exit:                                             ; preds = %"?ToString__im@Int32@System@bf@@SAXHPEAVString@23@@Z.exit", %if.else
  ret void
}

; Function Attrs: nounwind uwtable
define void @"?ToString__im@Int32@System@bf@@SAXHPEAVString@23@@Z"(i32 %this, ptr %strBuffer) local_unnamed_addr #1 {
entry:
  %strChars = alloca [16 x i8], align 1
  %0 = icmp slt i32 %this, 0
  %1 = tail call i32 @llvm.abs.i32(i32 %this, i1 false)
  %notsub17 = add i32 %1, -1
  %2 = icmp sgt i32 %notsub17, -1
  br i1 %2, label %while.body, label %if.then1

while.body:                                       ; preds = %entry, %while.body
  %char8Idx.019 = phi i32 [ %9, %while.body ], [ 14, %entry ]
  %.pn18 = phi i32 [ %8, %while.body ], [ %1, %entry ]
  %3 = sext i32 %char8Idx.019 to i64
  %4 = getelementptr inbounds [16 x i8], ptr %strChars, i64 0, i64 %3
  %5 = urem i32 %.pn18, 10
  %6 = trunc i32 %5 to i8
...
if.end4:                                          ; preds = %if.then3, %if.end2
  ...
  %16 = add nsw i64 %15, 1
  %17 = getelementptr inbounds [16 x i8], ptr %strChars, i64 0, i64 %16
...
; Function Attrs: nounwind uwtable
declare void @"?NumberToString@NumberFormatter@System@bf@@SAXUStringView@23@HPEAVIFormatProvider@23@PEAVString@23@@Z"(ptr, i64, i32, ptr, ptr) local_unnamed_addr #1
