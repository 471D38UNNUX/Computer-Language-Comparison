...
define void @"??B?$Span@H@System@bf@@SA?AU012@PEAV?$Array1@H@12@@Z"(ptr noalias nocapture writeonly sret(%"corlib.?$Span@H@System@bf") %0, ptr %array) local_unnamed_addr #0 {
entry:
  %1 = icmp eq ptr %array, null
  br i1 %1, label %"?__BfCtor@?$Span@H@System@bf@@QEAAXPEAV?$Array1@H@23@@Z.exit", label %if.end.i

if.end.i:                                         ; preds = %entry
  %2 = getelementptr inbounds %"corlib.?$Array1@H@System@bf", ptr %array, i64 0, i32 1
  %3 = getelementptr inbounds %"corlib.Array@System@bf", ptr %array, i64 0, i32 1
  %4 = load i32, ptr %3, align 4
  %5 = sext i32 %4 to i64
  br label %"?__BfCtor@?$Span@H@System@bf@@QEAAXPEAV?$Array1@H@23@@Z.exit"

"?__BfCtor@?$Span@H@System@bf@@QEAAXPEAV?$Array1@H@23@@Z.exit": ; preds = %entry, %if.end.i
...
define i64 @"?get__Length__im@?$Span@H@System@bf@@QEAATint@@XZ"(ptr nocapture readnone %this_mPtr, i64 returned %this_mLength) local_unnamed_addr #1 {
entry:
  ret i64 %this_mLength
}

; Function Attrs: alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define ptr @"?get____im@UCHK$?$Span@H@System@bf@@QEAAAEAHTint@@@Z"(ptr readnone %this_mPtr, i64 %this_mLength, i64 %index) local_unnamed_addr #1 {
entry:
  %0 = getelementptr inbounds i32, ptr %this_mPtr, i64 %index
  ret ptr %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define void @"?__BfCtor@?$Span@H@System@bf@@QEAAXPEAV?$Array1@H@23@@Z"(ptr nocapture writeonly %this, ptr %array) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %entry
  %1 = getelementptr inbounds %"corlib.?$Span@H@System@bf", ptr %this, i64 0, i32 1
  %2 = getelementptr inbounds %"corlib.?$Array1@H@System@bf", ptr %array, i64 0, i32 1
  store ptr %2, ptr %1, align 8
  %3 = getelementptr inbounds %"corlib.?$Span@H@System@bf", ptr %this, i64 0, i32 2
